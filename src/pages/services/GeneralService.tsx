      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-orange-700">
        <div className="container mx-auto px-4">
          <div className="text-center text-white">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">General Service</h1>
            <p className="text-xl text-orange-100 max-w-2xl mx-auto">
              Complete vehicle maintenance and inspection service to keep your vehicle in top condition
            </p>
          </div>
        </div>
      </section>
                ...
                <Card className="p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-6 w-6 text-green-600 mt-1" />
                      <div>
                        <h3 className="font-semibold text-gray-900">Air Filter Check</h3>
                        <p className="text-gray-600 text-sm">Inspect and clean air filter</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-6 w-6 text-green-600 mt-1" />
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Complete brake system check</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-6 w-6 text-green-600 mt-1" />
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Adjust tire pressure to optimal levels</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-6 w-6 text-green-600 mt-1" />
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Battery health and charge check</p>
                      </div>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="p-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900">Vehicle Inspection</h3>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Professional service using genuine parts and quality materials</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0 w-8 h-8 bg-orange-600 text-white rounded-full flex items-center justify-center font-bold">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Final inspection to ensure everything is working perfectly</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0 w-8 h-8 bg-orange-600 text-white rounded-full flex items-center justify-center font-bold">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Your vehicle is delivered back to you in perfect condition</p>
                      </div>
                    </div>
                  </div>
                </Card>
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6">
                ...
                <div className="space-y-3">
                  <Link to="/services/oil-change" className="block text-orange-600 hover:text-orange-700">
                    Oil Change Service
                  </Link>
                  <Link to="/services/brake-service" className="block text-orange-600 hover:text-orange-700">
                    Brake Service
                  </Link>
                  <Link to="/services/ac-service" className="block text-orange-600 hover:text-orange-700">
                    AC Service
                  </Link>
                  <Link to="/services/battery-service" className="block text-orange-600 hover:text-orange-700">
                    Battery Service
                  </Link>
                </div>
              </Card>
